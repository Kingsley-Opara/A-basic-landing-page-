...
function Contact() {
  return (
    <>
        ...
        <div className = 'mt-1 justify-center self-center place-content-center pb-12'>
            <form>
                <div className = 'flex flex-col justify-center self-center place-content-center align-middle space-y-6'>
                    ...
                    <div>
                        <input type = 'text' className = "h-3 w-[46rem] text-white bg-[#D3D3D3] p-5 max-md:w-[22rem]" 
                    ...
                    <div>
                        <textarea rows="7" cols="50" placeholder = "Message" className = 'w-[45rem] p-5 max-md:w-[22rem] bg-[#D3D3D3]'></textarea>
                    </div>
